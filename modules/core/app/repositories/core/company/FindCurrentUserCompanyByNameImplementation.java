...
public class FindCurrentUserCompanyByNameImplementation implements FindCurrentUserCompanyByNameAbstraction {
    ...
    @Inject
    public FindCurrentUserCompanyByNameImplementation(
                ...
                () -> {
                    try {
                        ...
                        return ebeanServer.find(CompanyModel.class).where().eq("user", userModel)
                                .eq("companyName", companyName).findOneOrEmpty();
