...
public class FindCurrentUserCompanyByPhoneImplementation implements FindCurrentUserCompanyByPhoneAbstraction {
    ...
    @Inject
    public FindCurrentUserCompanyByPhoneImplementation(
