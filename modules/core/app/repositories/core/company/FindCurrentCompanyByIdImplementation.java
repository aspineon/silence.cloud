...
public class FindCurrentCompanyByIdImplementation implements FindCurrentCompanyByIdAbstraction {
    ...
    @Inject
    public FindCurrentCompanyByIdImplementation(
    ...
    public CompletionStage<Optional<CompanyModel>> findCurrentCompanyById(Long id) {
        ...
        return supplyAsync(
                () -> {
                    try {
                        return ebeanServer.find(CompanyModel.class).setId(id).findOneOrEmpty();
