...
lazy val sms = (project in file(".")).enablePlugins(PlayJava, PlayEbean)
...
libraryDependencies += "pl.smsapi" % "smsapi-lib" % "2.4"
...
resolvers += "smsapi smsapi" at "http://labs.smsapi.com/maven/"